...
export default function CTA() {
  ...
  return (
    <div
      ...
      } fixed inset-x-0 bottom-5 mx-5 flex max-w-screen-xl flex-col items-center justify-between space-y-3 rounded-lg border-t-4 border-black bg-white px-5 pb-3 pt-0 drop-shadow-lg transition-all duration-150 ease-in-out dark:border dark:border-t-4 dark:border-gray-700 dark:bg-gray-900 dark:text-white
    ...
    >
      ...
      <div className="text-center lg:text-left">
        ...
        <p
          ...
          } mt-2 text-sm text-gray-700 dark:text-gray-300 lg:mt-0`}
        >
      ...
      >
        <a
          className="whitespace-no-wrap flex-auto rounded-md border border-gray-200 px-5 py-1 font-title text-lg text-black transition-all duration-150 ease-in-out hover:border-black dark:border-gray-700 dark:text-white dark:hover:border-white sm:py-3"
