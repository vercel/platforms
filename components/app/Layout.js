          ...
          <div className="flex justify-between items-center h-full max-w-screen-xl mx-auto px-10 sm:px-20">
            ...
            <div className="flex space-x-5">
              <a
                ...
                target="_blank"
                className="font-cal flex items-center space-x-2 border-2 border-black bg-black text-white px-5 py-3 hover:text-black hover:bg-white transition-all ease-in-out duration-150"
              >
                <p>Build my own</p>
                <svg
