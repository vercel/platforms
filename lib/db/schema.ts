import { pgTable, uniqueIndex, index, text, timestamp, serial, integer, boolean, primaryKey } from "drizzle-orm/pg-core"
...
export const users = pgTable("user", {
	...
	updatedAt: timestamp("updated_at", { precision: 3, mode: 'date' }).notNull().$onUpdate(() => new Date())
});
...
export const sites = pgTable("site", {
	...
	imageBlurhash: text("image_blurhash").default('data:image/png;base64,'),
...
export const posts = pgTable("post", {
	...
	siteId: text("site_id").references(() => sites.id, { onDelete: "cascade", onUpdate: "cascade" } ),
	userId: text("user_id").references(() => users.id, { onDelete: "cascade", onUpdate: "cascade" } ),
},
(table) => {
	return {
