...
export default function Tweet({id, metadata}) {
    ...
    return (
        <div className="tweet text-left rounded-lg border border-gray-300 dark:border-gray-800 px-8 pt-6 pb-2 my-4 w-full">
            ...
            <div className="border-t border-gray-300 pt-1 flex space-x-6 text-base !text-gray-700 dark:!text-gray-300 mt-2">
                <a
                ...
                >   
                    ...
                    <span className="group-hover:!text-red-600 group-hover:!underline">{new Number(public_metrics.like_count).toLocaleString()}</span>
                </a>
                <a
                ...
                rel="noopener noreferrer"
                >
                    <div className="group-hover:!text-twitter-blue rounded-full w-10 h-10 group-hover:bg-blue-100 flex items-center justify-center">
                        <svg width="24" height="24" viewBox="0 0 24 24">
                            <path
                            className="fill-current"
                ...
                <span className="group-hover:!text-twitter-blue group-hover:!underline">{new Number(public_metrics.reply_count).toLocaleString()}</span>
                </a>
                <button
                className="flex items-center mr-4 !text-gray-500 group transition !no-underline space-x-1"
                onClick={() => {
                ...
                >
                    <div className="group-hover:!text-green-600 rounded-full w-10 h-10 group-hover:bg-green-100 flex items-center justify-center">
                        <svg width="24" height="24" viewBox="0 0 24 24">
                            <path
                            className="fill-current"
                            d={copied ? "M9 20c-.264 0-.52-.104-.707-.293l-4.785-4.785c-.39-.39-.39-1.023 0-1.414s1.023-.39 1.414 0l3.946 3.945L18.075 4.41c.32-.45.94-.558 1.395-.24.45.318.56.942.24 1.394L9.817 19.577c-.17.24-.438.395-.732.42-.028.002-.057.003-.085.003z"
